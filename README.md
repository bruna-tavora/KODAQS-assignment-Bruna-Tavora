...
I then used this code both to obtain an overview of my dataset and to practice different coding strategies. My dataset consists of digital behavioral data extracted using the web application YouTube Data Tools, which was used to collect all videos published on the YouTube channel of the coalition. The downloaded CSV contains a column with keywords provided by the channel's users. YTDT is part of the Digital Methods Initiative, UvA (https://ytdt.digitalmethods.net/faq.php)
